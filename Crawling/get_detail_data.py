...
def musinsa_crawling(item_num):
    ...
    service = Service('D:\Sooo\Crawling\chromedriver')
...
for i in range(len(Detail_list)):
    ...
    local_file = open('D:\Sooo\detail_img_data' + '코디' + Detail_list[i][0] + '_' + str(Detail_list[i][5]) + '.jpg', 'wb')
...
f = open('D:\Sooo\Crawling\detail_data.csv', 'a', encoding='utf-8-sig')
